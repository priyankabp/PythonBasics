...
#You've contacted the FIFA for some data and they handed you two lists. ' \
#The lists are the following: positions = ['GK', 'M', 'A', 'D', ...] heights = [191, 184, 185, 180, ...] ' \
...
#Some of your friends don't believe you, so you are determined to show them using the data you received from FIFA and your newly acquired ' \
#Python skills.
